...
.then(obj => {
    ...
    if (currentTime>sunrise && currentTime<sunset && isRaining) {
        ...
        backgroundCover.style = 'background-image: url(./weatherAppPhotos/RainNight.png)'
        ...
        backgroundCover.style = 'background-image: url(./weatherAppPhotos/RainDay.png)'
        edgeDiv.style = 'background-color: antiquewhite;'
    } else if ((currentTime<sunrise || currentTime>sunset) && isRaining) {
        body.style = 'background-image: url(./weatherAppPhotos/NightLightning.png)'
        backgroundCover.style = 'background-image: url(./weatherAppPhotos/NightLightning.png)'
        edgeDiv.style = 'background-color: black;'
    } else {
        body.style = 'background-image: url(./weatherAppPhotos/ClearNightTwo.png)'
        backgroundCover.style = 'background-image: url(./weatherAppPhotos/ClearNightTwo.png)'
        edgeDiv.style = 'background-color: black;'
    }
})